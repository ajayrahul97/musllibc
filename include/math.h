...
__ISREL_DEF(lessl, <, double)
__ISREL_DEF(lessequalf, <=, float_t)
__ISREL_DEF(lessequal, <=, double_t)
__ISREL_DEF(lessequall, <=, double)
__ISREL_DEF(lessgreaterf, !=, float_t)
__ISREL_DEF(lessgreater, !=, double_t)
__ISREL_DEF(lessgreaterl, !=, double)
__ISREL_DEF(greaterf, >, float_t)
__ISREL_DEF(greater, >, double_t)
__ISREL_DEF(greaterl, >, double)
__ISREL_DEF(greaterequalf, >=, float_t)
__ISREL_DEF(greaterequal, >=, double_t)
__ISREL_DEF(greaterequall, >=, double)
...
#ifdef _GNU_SOURCE
double lgammal_r(double, int*);

void        sincos(double, double*, double*);
void        sincosf(float, float*, float*);
void        sincosl(double, double*, double*);

double      exp10(double);
float       exp10f(float);
double exp10l(double);

double      pow10(double);
float       pow10f(float);
double pow10l(double);
#endif
